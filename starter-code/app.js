...
const sumAndProductNew = (a, b) => `${a} + ${b} ${a} * ${b}`;
...
const studentNew = (name, age, hometown) => {
  return `new student '${joe}' and '${age} ${hometown}'`
}
console.log (joe)
...
const student = greeting =>  `Hi, my name is ${joe}'`
console.log(joe.greeting());
...
const courseNameNew = (course) => {
  return `I am currently enrolled in ${course}`;
};

console.log('I am currently enrolled in', courseNameNew('Code 301'));
